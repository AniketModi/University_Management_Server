...
module.exports = {
    addAdmin: async (req, res, next) => {
        try {
            const { name, email, password,dob, department, contactNumber } = req.body
    ...
    adminLogin: async (req, res, next) => {
        try {
            ...
            const isCorrect = await password==admin.password
            if (!isCorrect) {
    ...
    addStudent: async (req, res, next) => {
        try {
            ...
            const { name, email, year, fatherName,password,
    ...
    addFaculty: async (req, res, next) => {
        try {
            ...
            const { name, email, designation, password,department, facultyMobileNUmber ,
                 dob, gender } = req.body
